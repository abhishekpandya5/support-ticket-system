...
| Frontend component unit tests | Partial | Utility/schema/filter unit tests in `client/src/**/*.test.ts` |
| State machine unit tests | Implemented | `server/tests/unit/ticketStateMachine.test.ts` |
