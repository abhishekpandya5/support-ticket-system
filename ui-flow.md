...
- [`acceptance-criteria.md`](acceptance-criteria.md) §2
...
*This document is the UI design baseline for frontend implementation. Components and flows must align with [`api-contract.md`](api-contract.md) and [`tool-specific/cursor-workflow/spec.md`](tool-specific/cursor-workflow/spec.md).*
