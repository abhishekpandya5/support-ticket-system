...
Per exercise expectations, maintain notes (e.g., `docs/testing-notes.md`) documenting failures found, AI-assisted debugging steps, and fixes — including reference to commits where AI mistakes were corrected.
...
| # | Criterion | Verification |
|---|-----------|--------------|
| AC-14 | Requirement analysis document exists | `docs/requirements-analysis.md` |
| AC-15 | Prompt history maintained | `docs/prompt-history.md` |
