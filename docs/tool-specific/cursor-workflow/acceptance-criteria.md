...
- [`requirements-analysis.md`](../../requirements-analysis.md) — AC-01 through AC-17
- [`spec.md`](./spec.md) — technical design baseline
- [`tasks.md`](./tasks.md) — implementation task checklist
- [`project-context.md`](./project-context.md) — stack and principles
...
| TEST-16 | Should | Testing notes documented | `docs/testing-notes.md` exists with ≥1 debugging example | M | Spec §10.9 |
...
| DOC-08 | Should | Architecture overview | Brief description of React + Node + MongoDB stack with link to `docs/` | M | NFR-10 |

### 7.2 Lifecycle Artifacts

| ID | Priority | Criterion | Pass condition | Verification | Req ref |
|----|----------|-----------|----------------|--------------|---------|
| DOC-09 | Must | Requirements analysis | `docs/requirements-analysis.md` exists and is current (v1.1+) | M | AC-14 |
| DOC-10 | Must | Prompt history | `docs/prompt-history.md` exists with append-only entries | M | AC-15 |
| DOC-11 | Must | Project context | `docs/tool-specific/cursor-workflow/project-context.md` exists | M | AC-17 |
| DOC-12 | Must | Technical spec | `docs/tool-specific/cursor-workflow/spec.md` exists | M | AC-17 |
| DOC-13 | Must | Tasks breakdown | `docs/tool-specific/cursor-workflow/tasks.md` exists | M | AC-17 |
| DOC-14 | Must | Acceptance criteria | This document exists | M | AC-17 |
| DOC-15 | Should | Testing notes | `docs/testing-notes.md` exists | M | Spec §10.9 |
